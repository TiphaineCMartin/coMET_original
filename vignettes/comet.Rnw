...
source("../R/AnalyseFile.R")
source("../R/BiofeatureGraphics.R")
source("../R/comet.R")
source("../R/cometWeb.R")
source("../R/DrawPlot.R")
source("../R/GeneralMethodComet.R")

#extdatacoMET <- system.file("extdata", package="coMET",mustWork=TRUE)
@
...
#configfile <- importScore(file.path(extdata, "config_cyp1b1_zoom.txt"), format="TXT")
